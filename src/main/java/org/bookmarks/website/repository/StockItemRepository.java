...
public interface StockItemRepository extends CrudRepository<StockItem, Long>, PagingAndSortingRepository<StockItem, Long> {
	...
	List<StockItem> findAuthorsOtherStockItems(@Param("id") Long id, @Param("stockItemId") Long stockItemId,
			Pageable pageable);
	...
	void updateStockItem(@Param("id") Long id, @Param("imageFilename") String imageFilename,
			@Param("title") String title, @Param("sellPrice") BigDecimal sellPrice,
			@Param("availability") Availability availability, @Param("quantityInStock") Long quantityInStock);
	...
	void updateBounciesAndStickies(@Param("id") Long id, @Param("bouncyIndex") Long bouncyIndex,
			@Param("stickyCategoryIndex") Long stickyCategoryIndex, @Param("stickyTypeIndex") Long stickyTypeIndex);
