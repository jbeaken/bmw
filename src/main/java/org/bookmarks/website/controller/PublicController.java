...
public class PublicController extends AbstractBookmarksWebsiteController {
    ...
    /**
     * Get the stock item,
     * add 'interesting' which is the best sellers from the stockitem category
     * add other authors stockitems until reach a max of 5
     * @param stockItemId
     * @param modelMap
     * @return
     */
    ...
    public String viewStockItem(@PathVariable("stockItemId") Long stockItemId, ModelMap modelMap, HttpServletResponse response) {
        ...
        for(Author a : stockItem.getAuthors()) {
        	...
        	if(authorsOtherBooks.size() > 4) break;
        }
...
//    	return "redirect:https://www.kickstarter.com/projects/556239072/1917-russias-red-year-100th-anniversary-graphic-no";
//    }
...
//    }
    ...
    public String paySponsorship(@Valid SponsorForm sponsorForm, BindingResult result, ModelMap model, HttpSession session) {
    	...
    	if(result.hasErrors()) {
			...
			StockItem stockItem = stockItemRepository.findOne(39315l); //Sponsorship stockitem
...
//    private void sendSponsorshipPaidEmail(SponsorForm contactForm) throws MessagingException {
...
//		    message.setBcc(new String[]{"jack747@gmail.com", "sarahensor@hotmail.co.uk"});
//	    }
//
//	 // Create the HTML body using Thymeleaf
//	    final String htmlContent = this.templateEngine.process("/mail/sponsor.html", ctx);
...
//    public String sponsor(@Valid SponsorForm contactForm, BindingResult result, ModelMap model, RedirectAttributes redirectAttributes) {
...
//		}
//
//    	redirectAttributes.addFlashAttribute("thankYouMessage", "Thank you for sponsoring us.");
//
//    	return "redirect:/thankYou";
//    }
//
    ...
    /**
     * thankYouMessage will have already been saved in flash scope
     * e.g. redirectAttributes.addFlashAttribute("thankYouMessage", "Thank you, we will reply as soon as possible");
     * @return
     */
...
//	private void sendSponsorEmail(SponsorForm sponsorForm) throws MessagingException {
//		 // Prepare the evaluation context
//	    final Context ctx = new Context();
